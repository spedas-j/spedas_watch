...
;
;ROUTINES:
;   initct : Replaces loadct2.  Works the same way as loadct2, but provides access to
;            over 100 new color tables.  Provides keywords for setting line colors.
...
; $LastChangedDate: 2023-02-26 15:24:09 -0800 (Sun, 26 Feb 2023) $
; $LastChangedRevision: 31535 $
...
; Use gray instead of white for the background, which looks better with some color tables
...
options, varname, 'line_colors', mylines

; Disable custom color tables and line colors for a tplot variable

options, varname, 'color_table', -1
