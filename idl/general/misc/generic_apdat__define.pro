...
pro generic_apdat::average,range=range,binsize=binsize,tspan=tspan
  ...
  if n_elements(datarray) gt 1 then begin
    t=datarray.time
    mt=median([t])
...
function generic_apdat::sw_version
  ...
  sw_hash['svn_changedby '] = '$LastChangedBy: ali $'
    sw_hash['svn_changedate'] = '$LastChangedDate: 2026-09-03 11:46:10 -0700 (Thu, 03 Sep 2026) $'
    sw_hash['svn_revision '] = '$LastChangedRevision: 34870 $'
...
function generic_apdat::cdf_global_attributes
  ...
  ;  global_att['SVN_CHANGEDATE'] = '$LastChangedDate: 2026-09-03 11:46:10 -0700 (Thu, 03 Sep 2026) $'
  ;  global_att['SVN_REVISION'] = '$LastChangedRevision: 34870 $'
