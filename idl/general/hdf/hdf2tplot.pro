...
pro hdf2tplot, filenames, tplotnames=tplotnames, varnames=varnames, merge=merge, prefix=prefix, suffix=suffix, verbose=verbose, gatt2istp=gatt2istp, time_offset=time_offset, _extra=_extra
  ...
  foreach fname, filenames do begin
    ...
    cdf_struct = hdf_to_cdfstruct(hdfi, fname, varnames=varnames, verbose=verbose, gatt2istp=gatt2istp, time_offset=time_offset)
