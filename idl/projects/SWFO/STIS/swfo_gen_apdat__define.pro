...
pro swfo_gen_apdat::handler,ccsds,source_dict=source_dict ;,header,source_info=source_info
  ...
  if ccsds.time ge time_double('2020-1-1') then begin
...
function swfo_gen_apdat::sw_version
  ...
  sw_hash['svn_changedby '] = '$LastChangedBy: davin-mac $'
    sw_hash['svn_changedate'] = '$LastChangedDate: 2023-12-02 00:12:52 -0800 (Sat, 02 Dec 2023) $'
    sw_hash['svn_revision '] = '$LastChangedRevision: 32262 $'
...
function swfo_gen_apdat::cdf_global_attributes
  ...
  ;  global_att['SVN_CHANGEDATE'] = '$LastChangedDate: 2023-12-02 00:12:52 -0800 (Sat, 02 Dec 2023) $'
  ;  global_att['SVN_REVISION'] = '$LastChangedRevision: 32262 $'
