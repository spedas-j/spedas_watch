...
function swfo_sc_130_apdat::decom,ccsds,source_dict=source_dict
  ...
  datastr = {$
    ...
    stis_interface_temp_raw2:         swfo_data_select(ccsds_data,436    ,12),$
    stis_temp1_raw2:                  swfo_data_select(ccsds_data,700    ,12),$
    stis_temp2_raw2:                  swfo_data_select(ccsds_data,736    ,12),$
    gap:ccsds.gap }
