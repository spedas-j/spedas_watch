...
; $LastChangedDate: 2019-07-15 15:50:06 -0700 (Mon, 15 Jul 2019) $
; $LastChangedRevision: 27453 $
...
function flatten_spectra_ut::test_xvals_yvals_to_flux
  ...
  assert, (yv['mms3_dis_energyspectr_omni_fast'])[0] eq 13880.317, 'Problem with to_flux keyword'
