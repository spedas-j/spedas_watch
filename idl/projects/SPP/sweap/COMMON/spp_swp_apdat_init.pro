...
pro spp_swp_apdat_init,reset=reset, save_flag = save_flag, $
   ...
   spp_apdat_info,'342'x,name='swem_memdump', apid_obj='spp_swp_swem_memdump_apdat',  tname='spp_swem_memdump_',   save_flag=save_flag,ttags='*',rt_flag=rt_flag
   ...
   spp_apdat_info,'3b8'x,name='spi_memdump', apid_obj='spp_swp_span_memdump_apdat',       tname='spp_spi_memdump_', ttags='*',save_flag=save_flag,rt_flag=rt_flag
   ...
   ;; Memory Dump
   ;;----------------------------------------------------------------------------------------------------------------------------------------
   spp_apdat_info,'36d'x,name='spa_memdump' ,tname='spp_spa_memdump_',ttags='SEQN', save_flag=save_flag,rt_flag=rt_flag 
   ...
   ;; Memory Dump
   ;;----------------------------------------------------------------------------------------------------------------------------------------
   spp_apdat_info,'37d'x ,name='spb_memdump',                      tname='spp_spb_dump_',  save_flag=save_flag,rt_flag=rt_flag 
