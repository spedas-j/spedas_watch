...
if keyword_set(simple) then begin
  ...
  case strlowcase(units) of
    ...
    'df'     : begin
      if keyword_set(relativistic) then ustr = ['f (', '(c/MeV/cm)^3', ')'] else ustr = ['f (', 's^3 / km^6', ')']
    end
  ...
  case strlowcase(units) of
    ...
    'df'     : begin
      if keyword_set(relativistic) then ustr = ['f (', '(c/MeV/cm)!U3!N', ')'] else ustr = ['f (', 's!U3!N/km!U6!N', ')']
    end
