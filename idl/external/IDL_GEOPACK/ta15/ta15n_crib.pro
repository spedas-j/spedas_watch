...
tomni2nindex,imf_by='BY_smooth',imf_bz='BZ_smooth',sw_speed='flow_speed_smooth',out_name='n_index'

tplot,'OMNI_HRO_5min_BY_GSM BY_smooth OMNI_HRO_5min_BZ_GSM BZ_smooth OMNI_HRO_5min_flow_speed flow_speed_smooth pdyn_smooth n_index'

thm_load_state,probe='a',datatype='pos',coord='GSM'

tta15n,'tha_state_pos',pdyn='pdyn_smooth',yimf='BY_smooth',zimf='BZ_smooth',xind='n_index'
end